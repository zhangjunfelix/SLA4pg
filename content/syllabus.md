...
1. Explain major theoretical proposals in L2 acquisition and how they derive predictions.  
2. Critically evaluate empirical studies (design, measures, analyses, interpretations).  
3. Compare acquisition across modules (morphology, syntax, lexicon) and interfaces.  
4. Relate L2 processing findings (e.g., eye-tracking, ERP) to competence and instruction.  
...
- **Style**: APA or LSA; be consistent.
